...
- Chirp duration: 1 ms
- Repeat period: 20 ms
- Waveform file: `D:\LoRaSensing\Dong\chime_test_tx_period_fc32.bin`
...
- RF bandwidth: 2 MHz
- RX gain: 20 dB
- Output: `D:\LoRaSensing\Dong\chime_test_rx_fc32.bin`
...
- `D:\LoRaSensing\Dong\chime_test_spectrogram.png`
- `D:\LoRaSensing\Dong\chime_test_paths.csv`
- `D:\LoRaSensing\Dong\chime_test_summary.json`
