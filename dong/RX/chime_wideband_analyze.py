...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--infile", default=r"D:\LoRaSensing\Dong\chime_test_rx_fc32.bin")
    ...
    parser.add_argument("--csv-out", default=r"D:\LoRaSensing\Dong\chime_test_paths.csv")
    parser.add_argument("--json-out", default=r"D:\LoRaSensing\Dong\chime_test_summary.json")
