...
/*!
 * Fixed LoRaMAC frame counter for repeatable PHY experiments.
 * Keeping every transmitted byte unchanged makes the SX1276 generate the
 * same encoded LoRa symbol sequence for every packet.
 */
