...
LoRaMacStatus_t RegionCN470NextChannel( NextChanParams_t* nextChanParams, uint8_t* channel, TimerTime_t* time, TimerTime_t* aggregatedTimeOff )
{
    ...
    if( nbEnabledChannels > 0 )
    {
        ...
        ////*channel = enabledChannels[randr( 0, nbEnabledChannels - 1 )];////modify by xzq in 2019.2.19
				*channel = enabledChannels[randr( 80, 87 )];//[486.3, 486.5, 486.7, 486.9, 487.1, 487.3, 487.5, 487.7]
