...
void HAL_UART_TxCpltCallback( UART_HandleTypeDef *handle )//Tx Transfer completed callback
{
...
void HAL_UART_RxCpltCallback( UART_HandleTypeDef *handle )//Rx Transfer completed callback
{
